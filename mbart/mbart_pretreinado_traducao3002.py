...
def traduzir_poema_em_partes(poema, src_lang="en_XX", tgt_lang="fr_XX"):
...
file_path = "../poemas/test/ingles_frances_test.csv"
...
df.to_csv("../poemas/mbart/finetuning_musics/ingles_frances.csv", index=False)
