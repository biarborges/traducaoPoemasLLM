...
model_name = "/home/ubuntu/finetuning_en_pt/checkpoint-252"
...
def traduzir_poema_em_partes(poema, src_lang="en_XX", tgt_lang="pt_XX"):
...
file_path = "../poemas/test/ingles_portugues_test.csv"
...
df.to_csv("../poemas/mbart/finetuning_musics/ingles_portugues.csv", index=False)
