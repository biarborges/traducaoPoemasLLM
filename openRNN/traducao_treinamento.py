...
MODEL_PATHS = {
    ("en_XX", "fr_XX"): "../openRNN/models_en_fr/model_en_fr_step_50000.pt"
    # Adicione mais idiomas se necessário
}

#CSV_PATH = "../poemas/poemas300/test/ingles_frances_test.csv"
#OUTPUT_CSV = "../poemas/poemas300/openRNN/ingles_frances_test_pretreinado_openRNN.csv"

CSV_PATH = "../poemas/poemas300/ingles_frances_poems.csv"
