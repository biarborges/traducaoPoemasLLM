...
MODEL_PATHS = {
    ("fr_XX", "pt_XX"): "../openRNN/output_model_duplo/model_step_10000.pt"

}

CSV_PATH = "../poemas/test/frances_portugues_test.csv"
OUTPUT_CSV = "../poemas/openRNN/finetuning_musics/frances_portugues.csv"
