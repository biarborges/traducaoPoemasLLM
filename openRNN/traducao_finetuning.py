...
MODEL_PATHS = {
    ("pt_XX", "fr_XX"): "../openRNN/output_model_duplo/model_step_10000.pt"

}

CSV_PATH = "../poemas/test/portugues_frances_test.csv"
OUTPUT_CSV = "../poemas/openRNN/finetuning_musics/portugues_frances.csv"
