...
MODEL_PATHS = {
    ("fr_XX", "en_XX"): "../openRNN/output_model_duplo/model_step_10000.pt"

}

CSV_PATH = "../poemas/test/frances_ingles_test.csv"
OUTPUT_CSV = "../poemas/openRNN/finetuning_musics/frances_ingles.csv"
