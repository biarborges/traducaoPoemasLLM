...
TITLE = "mbart"
CAMINHO_CSV = "modelagemTopicos/results/frances_portugues/mbart/poemas_com_topicos.csv" 
PASTA_SAIDA = "modelagemTopicos/results/frances_portugues/mbart"
...
if __name__ == '__main__':
    ...
    if IDIOMA_PROC == "fr_XX":
        stopwords_personalizadas.update(["le", "la", "les", "un", "une", "jean", "john", 
                                         ...
                                         "isabelle","travers", "isabel","tandis", "jusque", "the", "and", "french", "être", "you", "tour"])
        ...
        stopwords_personalizadas.update(["o", "a", "os", "as", "um", "uma", "eu", 
                                         ...
                                         "senão", "senao", "alexandre", "sha", "quot","unk",
                                         
                                         "the", "a", "an", "and", "but", "or", "so", "to",
                                         "of", "in", "for", "on", "at", "you", "your", "they",
                                         "he", "she", "it", "we", "us", "them","our", "their",
                                         "this", "that", "is", "are", "was", "were","not", "no", "yes","will", "shall","are", "be", "been", "being","not", "no", "yes",
                                         "i", "me", "my", "mine", "you", "your","have", "has", "had", "having", "do", "does", "did", "doing",
                                         "if", "then", "when", "where", "why", "how", "amans", "miser", "mister", "with", "without", "about", "after", "before", "between", "under", "over", "again", "all", "any", "both", "each", "few", "more", "most", "other", "some", "such",
                                         "than", "that", "these", "those", "what", "which","these", "those", "what", "which", "who", "whom", "whose", "where", "why", "how",
                                         "again", "all", "any", "both", "each", "few", "more", "most", "other", "some", "such",
                                         "than", "that", "these", "those", "what", "which","who", "whom", "whose", "where", "why", "how",
                                         "i", "me", "my", "mine", "you", "your","he", "him", "his", "she", "her", "it", "its", "we", "us", "our", "they", "them", "their",
                                         "this", "that", "these", "those", "what", "which","unk", "thou", "thee", "thy", "thou", "thine", "ye", "you", "your", "yours","there", "here", "where", "when", "why", "how", "who", "whom", "whose",])
    ...
    def plot_top_words_todos_topicos(tfidf_matrix, feature_names, docs_por_topico, top_n=10, max_topicos=5):
        ...
        largura_barra = 0.6
        espacamento = 11  # espaço entre os grupos de tópicos

        plt.figure(figsize=(12, 5))  # imagem menor

        plt.rcParams.update({'font.size': 16})  # fonte maior
