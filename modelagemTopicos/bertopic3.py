...
IDIOMA_ORIGEM = "fr_XX"  # Opções: "fr_XX", "pt_XX", "en_XX"
IDIOMA_DESTINO = "en_XX" # Opções: "fr_XX", "pt_XX", "en_XX"
...
if __name__ == '__main__':
    ...
    topic_model = BERTopic(language="multilingual", nr_topics=7) # 3 até o 8
