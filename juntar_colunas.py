...
df1 = pd.read_csv('../traducaoPoemasLLM/poemas/maritaca/frances_ingles_poems_maritaca_prompt2.csv')
df2 = pd.read_csv('../traducaoPoemasLLM/poemas/maritaca/frances_ingles_poems_maritaca_prompt2_linhas_vazias_preenchidas.csv')
...
df1.to_csv('../traducaoPoemasLLM/poemas/maritaca/frances_ingles_poems_maritaca_prompt2_completo.csv', index=False)

print("Concluído! O arquivo foi salvo como '../traducaoPoemasLLM/poemas/maritaca/frances_ingles_poems_maritaca_prompt2_completo.csv'")