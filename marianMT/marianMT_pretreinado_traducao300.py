...
model_name = "Helsinki-NLP/opus-mt-ROMANCE-en"  # Modelo para tradução de fr para inglês
tokenizer = MarianTokenizer.from_pretrained(model_name)
model = MarianMTModel.from_pretrained(model_name).to(device)

# Carregar CSV
input_file = os.path.abspath("../poemas/poemas300/portugues_ingles_poems.csv")
output_file = os.path.abspath("../poemas/poemas300/marianmt/portugues_ingles_poems_traducao_marianmt.csv")
