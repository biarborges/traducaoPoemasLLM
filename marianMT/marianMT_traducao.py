...
model_name = "/home/ubuntu/finetuning_en_fr/checkpoint-2433"
...
#df = pd.read_csv('../poemas/test/ingles_frances_test.csv')
df = pd.read_csv('../poemas/ingles_frances_poems.csv')
...
df.to_csv('../poemas/marianmt/finetuning_musics/ingles_frances.csv', index=False)
