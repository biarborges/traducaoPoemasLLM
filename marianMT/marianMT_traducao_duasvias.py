...
model1 = "/home/ubuntu/finetuning_pt_en/checkpoint-2940"
model2 = "/home/ubuntu/finetuning_en_fr/checkpoint-2493"
...
df = pd.read_csv('../poemas/portugues_frances_poems.csv')
