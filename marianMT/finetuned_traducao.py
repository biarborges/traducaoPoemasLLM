...
model_path = "/home/ubuntu/finetuning/checkpoint-60"
input_file = os.path.abspath("../poemas/poemas300/test/ingles_frances_test.csv")
output_file = os.path.abspath("../poemas/poemas300/marianmt/ingles_frances_test_finetuning_marianmt_finetunedtraducao.csv")
